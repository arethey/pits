...
<div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM folders WHERE document_id = $id AND created_by = $user_id";
                    ...
                    if($result->num_rows > 0){
                        while($row = $result->fetch_array()){
                            echo '<tr>';
                                ...
                                echo "<td>-</td>";
                                echo "<td>";
                                    echo '<a href="folders.php?page=read&id='. $row['id'] .'">view</a>';
                                echo "</td>";
                            echo '</tr>';
                        }
                        // Free result set
            ...
            <?php
                $sql2 = "SELECT * FROM files WHERE document_id = $id AND created_by = $user_id  AND folder_id = 0 AND isArchived = 0";
